...
| Ag count is too low                        | Decrease `count_thr_rel`, `count_min_distance`, or `ag_min_object_size`; inspect `ag_tophat_radius`.                                                                               |
| Ag count is too high                       | Increase `count_thr_rel`, `count_min_distance`, and `ag_min_object_size`; display `Ag peaks` while tuning.                                                                         |
